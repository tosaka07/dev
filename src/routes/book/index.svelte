...
<div class="container py-10">
  ...
  <p class="mb-8 text-lg text-gray-600">読んだ本を、感想とあわせて残してます。</p>
  <ul class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-6 gap-10">
    {#each list as pair}
      <li>
        <a class="h-full flex flex-col flex-end justify-end" href="/book/{pair.post.slug}">
          <img
